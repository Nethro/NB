const handler = async (m, {conn, isROwner, text}) => {
  ...
  if (!pesan) throw '*Necesita Ingresar El Mensaje Que Desea Enviar A Los Grupos 🇦🇱*';
  ...
  for (const i of anu) {
    ...
    conn.relayMessage(i,
        {liveLocationMessage: {
          ...
          caption: '> *Olympus Bot Anuncio 🇦🇱*\n\n' + pesan + '\n\n> *Olympus Bot Anuncio 🇦🇱*',
          sequenceNumber: 2,
          timeOffset: 3,
          contextInfo: m,
        }}, {}).catch((_) => _);
  }
  m.reply(`> *𝙼𝙴𝙽𝚂𝙰𝙹𝙴 𝙴𝙽𝚅𝙸𝙰𝙳𝙾 𝙰 ${anu.length} 𝙶𝚁𝚄𝙿𝙾/𝚂*\n\n> *𝙴𝚂 𝙿𝙾𝚂𝙸𝙱𝙻𝙴 𝚀𝚄𝙴 𝚃𝙴𝙽𝙶𝙰 𝙵𝙰𝙻𝙻𝙾𝚂 𝙴𝚂𝚃𝙴 𝙲𝙾𝙼𝙰𝙽𝙳𝙾 𝚈 𝙽𝙾 𝚂𝙴 𝙴𝙽𝚅𝙸𝙴 𝙰 𝚃𝙾𝙳𝙾𝚂 𝙻𝙾𝚂 𝙲𝙷𝙰𝚃𝚂, 𝙳𝙸𝚂𝙲𝚄𝙻𝙿𝙴 𝙿𝙾𝚁 𝙴𝙻 𝙼𝙾𝙼𝙴𝙽𝚃𝙾*`);
};
